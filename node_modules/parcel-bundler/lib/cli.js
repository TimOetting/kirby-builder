...
function _bundle() {
  _bundle = (0, _asyncToGenerator2.default)(function* (main, command) {
    ...
    if (command.name() === 'serve' && command.target === 'browser') {
      const server = yield bundler.serve(command.port || 1234, command.https, command.host);
